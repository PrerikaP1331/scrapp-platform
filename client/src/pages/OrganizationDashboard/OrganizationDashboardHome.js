...
function OrganizationDashboardHome() {
  ...
  const StatCard = ({ icon: Icon, label, value, color = "#588157" }) => (
    <Paper p="md" radius="md" withBorder style={{ textAlign: "center" }}>
      ...
      <Text size="xl" fw={700} style={{ color: "#344e41" }}>
        {value}
      </Text>
    </Paper>
  );
    ...
    <Container size="xl">
      <Stack gap="lg">
        ...
        >
          ...
          <Text color="dimmed">
            Manage corporate sustainability initiatives and track environmental
            impact
          </Text>
        </Paper>
        ...
        {/* Quick Stats */}
        <div>
          <Title order={3} mb="md" style={{ color: "#344e41" }}>
          ...
          <SimpleGrid cols={{ base: 1, sm: 2, md: 3 }} gap="md">
            <StatCard
              ...
              value={orgStats.totalWasteRecycled}
            />
            <StatCard
              icon={IconRecycle}
              label="Monthly Cost Savings"
              value={orgStats.costSavings}
            />
            <StatCard
              icon={IconUsers}
              label="Employee Engagement"
              value={orgStats.employeeEngagement}
            />
            <StatCard
              icon={IconTarget}
              label="Active Initiatives"
              value={orgStats.activeInitiatives}
            />
            <StatCard
              icon={IconUsers}
        ...
        <div>
          ...
          <SimpleGrid cols={{ base: 1, sm: 2 }} gap="md">
            <Paper
              ...
              onClick={() => navigate("/org-dashboard/schedule")}
            >
              <Group>
                <ThemeIcon
                  size="lg"
                ...
                <div>
                  ...
                  <Text size="sm" color="dimmed">
                    Plan commercial waste collection
                  </Text>
                </div>
              </Group>
            </Paper>
            ...
            <Stack gap="md">
              ...
              >
                <div>
                  ...
                  <Text size="sm" color="dimmed">
                    245 kg of mixed waste collected
                  </Text>
                </div>
                <Text size="sm" fw={500} style={{ color: "#588157" }}>
                  Nov 16
                </Text>
              </Group>
              ...
              >
                <div>
                  <Text fw={600} style={{ color: "#344e41" }}>
                    Employee Joined Initiative
                  </Text>
                  <Text size="sm" color="dimmed">
                    45 employees joined Paper Reduction Challenge
                  </Text>
                </div>
                <Text size="sm" fw={500} style={{ color: "#588157" }}>
                  Nov 15
              ...
              <Group justify="space-between">
                <div>
                  ...
                  <Text size="sm" color="dimmed">
                    Monthly sustainability report ready for review
                  </Text>
                </div>
                <Text size="sm" fw={500} style={{ color: "#588157" }}>
                  Nov 14
