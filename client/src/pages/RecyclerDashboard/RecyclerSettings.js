    ...
    <Container size="lg" py="xl">
        ...
        >
          ...
          <Tabs.Panel value="account" pl="lg">
            <Paper p="lg" radius="md" withBorder>
              <Stack gap="lg">
                <div>
                  <Title order={4} style={{ color: "#1a535c" }} mb="xs">
                ...
                <div>
                  <Text fw={500} size="sm" mb="xs" style={{ color: "#1a535c" }}>
                    Business Associated:
                  </Text>
                  <Paper
                    p="md"
                  ...
                  >
                    <Text fw={600} style={{ color: "#1a535c" }}>
                      {businessName}
                    </Text>
                    <Text size="sm" color="dimmed" mt="xs">
                      This is the main business account. Account transfer
                      requires support assistance for security purposes.
                    </Text>
                  </Paper>
                </div>
          ...
          <Tabs.Panel value="danger" pl="lg">
            ...
            <Alert
              icon={<IconAlertCircle />}
              title="What Happens After Deactivation?"
              color="yellow"
              mt="lg"
            >
              <Stack gap="xs">
                <Text size="sm">
                  • Your profile will be hidden from the marketplace
                </Text>
                <Text size="sm">• You won't receive new pickup requests</Text>
                <Text size="sm">
                  • Your historical data and transactions are preserved
                </Text>
                <Text size="sm">
      ...
      >
        <Stack gap="lg">
          ...
          <div>
            <Text fw={600} mb="xs" style={{ color: "#1a535c" }}>
              To confirm, please type your business name:
            </Text>
            <Text fw={700} size="lg" mb="lg" style={{ color: "#c92a2a" }}>
              {businessName}
            </Text>
            <TextInput
              ...
              onChange={(e) =>
                setDeactivationConfirmation(e.currentTarget.value)
              }
            />
          </div>
